...
class Smartaddons_BasicProducts_Block_List extends Mage_Core_Block_Template
{
	...
	protected function _toHtml(){
		...
		$template_file = "smartaddons/basicproducts/block_template_default.phtml";
	...
	public function getScriptTags(){
		...
		if (null == Mage::registry('jsmart.jquery')){
			...
			if (Mage::getStoreConfigFlag('basicproducts_cfg/advanced/include_jquery')){
				...
				$import_str .= $jsHelper->includeSkinScript('smartaddons/basicproducts/js/jquery-1.5.min.js');
				Mage::register('jsmart.jquery', 1);
			}
		}
		if (null == Mage::registry('jsmart.jquerynoconfict')){
			// add once noConflict
			$import_str .= $jsHelper->includeSkinScript('smartaddons/basicproducts/js/jsmart.noconflict.js');
			Mage::register('jsmart.jquerynoconfict', 1);
		}
		
		if (null == Mage::registry('jsmart.basicproducts.js')){
			// add script for this module.
			// $import_str .= $jsHelper->includeSkinScript('smartaddons/basicproducts/js/jsfilename.js');
